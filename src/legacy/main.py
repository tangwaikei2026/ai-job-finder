"""Legacy AI Job Radar entry point retained for rollback.

Usage:
    python -m src.legacy.main
    python -m src.legacy.main --platform tencent
    python -m src.legacy.main --dry-run
    python -m src.legacy.main --tier 1
"""
...
from src.legacy.db import upsert_jobs, log_scrape_run, check_circuit_breaker
from src.models import JobPosting, load_jobs_from_json, save_jobs_to_json
from src.legacy.pipeline.normalizer import normalize_jobs
from src.legacy.pipeline.dedup import deduplicate
from src.legacy.pipeline.detail_fetcher import enrich_with_details
from src.legacy.pipeline.diff import compute_diff
from src.legacy.pipeline.filter import filter_strict
from src.legacy.report import generate_readme
from src.legacy.notifiers.feishu import send_feishu_notification

# Tier 1: 公司官网 API
from src.legacy.scrapers.tencent import TencentScraper
from src.legacy.scrapers.baidu import BaiduScraper
from src.legacy.scrapers.netease import NeteaseScraper

# Tier 1: 公司官网 Playwright (legacy, kept for fallback)
# Tier 2: 第三方招聘平台
from src.legacy.scrapers.boss import BossScraper
from src.legacy.scrapers.liepin import LiepinScraper
from src.legacy.scrapers.zhilian import ZhilianScraper
from src.legacy.scrapers.job51 import Job51Scraper
from src.legacy.scrapers.lagou import LagouScraper

# Tier 3: 浏览器自动化
from src.legacy.scrapers.linkedin import LinkedInScraper
from src.legacy.scrapers.maimai import MaimaiScraper
...
STANDALONE_SCRAPERS = {
    "quark": ("src.legacy.scrapers.quark", "scrape_quark"),
    "alibaba": ("src.legacy.scrapers.alibaba", "scrape_alibaba"),
    "antgroup": ("src.legacy.scrapers.antgroup", "scrape_antgroup"),
    "meituan": ("src.legacy.scrapers.meituan", "scrape_meituan"),
    "kuaishou": ("src.legacy.scrapers.kuaishou", "scrape_kuaishou"),
    "xiaohongshu": ("src.legacy.scrapers.xiaohongshu", "scrape_xiaohongshu"),
    "jd": ("src.legacy.scrapers.jd", "scrape_jd"),
    "huawei": ("src.legacy.scrapers.huawei", "scrape_huawei"),
    # Feishu Jobs (飞书招聘) - MiniMax, 智谱AI
    "feishu": ("src.legacy.scrapers.feishu", "scrape_feishu"),
    # MokaHR - DeepSeek, Kimi
    "moka": ("src.legacy.scrapers.moka", "scrape_moka"),
    # bb-browser powered (requires local Chrome + daemon)
    "bytedance": ("src.legacy.scrapers.bytedance_bb", "scrape_bytedance"),
    "didi": ("src.legacy.scrapers.didi_bb", "scrape_didi_bb"),
}
