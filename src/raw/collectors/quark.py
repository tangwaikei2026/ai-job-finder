...
class QuarkRawCollector(RawCollector):
    platform = "quark"
    ...
    def collect(self) -> CollectionResult:
        ...
        try:
            ...
            if not csrf_token:
                raise RuntimeError("Quark list page did not set XSRF-TOKEN")
            ...
            while True:
                ...
                if payload.get("success") is not True:
                    raise RuntimeError(
                        f"Quark API failed: {payload.get('errorCode')} "
                ...
                if page == 1:
                    manifest.source_total = int(content.get("totalCount") or 0)
