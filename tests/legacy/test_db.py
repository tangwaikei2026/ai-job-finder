...
from src.legacy.db import init_db, upsert_jobs, load_active_jobs, load_all_jobs, log_scrape_run, get_run_history
...
class TestCircuitBreaker:
    def test_no_history_returns_false(self, tmp_db):
        from src.legacy.db import check_circuit_breaker
