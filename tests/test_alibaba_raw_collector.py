...
from src.raw.collectors import AlibabaBaseCollector, COLLECTOR_REGISTRY
...
def test_alibaba_platforms_are_enabled_in_config():
    config_path = Path(__file__).parents[1] / "raw_config.yaml"
    config = yaml.safe_load(config_path.read_text(encoding="utf-8"))
    platforms = config["raw_collection"]["platforms"]
